  ...
  useEffect(() => {
    const fetchProductsAndUser = async () => {
      try {
        ...
        if (prodData.success) {
          let artisanProducts = prodData.data.filter(
          ...
          if (userData.success && userData.data) {
            ...
            artisanProducts = artisanProducts.map(
              (product: IProductResponse) => ({
                ...product,
          ...
          >();
          artisanProducts.forEach((product: IProductResponse) => {
          ...
          // Price Range
          const prices = artisanProducts.map(
          ...
          <div className="">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Artisan&apos;s</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
