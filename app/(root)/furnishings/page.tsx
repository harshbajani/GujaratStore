...
const FurnishingPage = () => {
  ...
  useEffect(() => {
    const fetchProductsAndUser = async () => {
      try {
        ...
        if (prodData.success) {
          let furnishingProducts = prodData.data.filter(
          ...
          if (userData.success && userData.data) {
            ...
            furnishingProducts = furnishingProducts.map(
              (product: IProductResponse) => ({
                ...product,
          ...
          // Set up product data
          setProducts(furnishingProducts);

          const primaryCatMap = new Map<
            string,
            { id: string; name: string; count: number }
          >();
          furnishingProducts.forEach((product: IProductResponse) => {
          ...
          // Price Range
          const prices = furnishingProducts.map(
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <BreadcrumbHeader title="Home" subtitle="Furnishings" titleHref="/" />
