...
const HomeDecorPage = () => {
  ...
  useEffect(() => {
    const fetchProductsAndUser = async () => {
      try {
        ...
        if (prodData.success) {
          let homeDecorProducts = prodData.data.filter(
            (product: IProductResponse) =>
              product.parentCategory?.name?.toLowerCase() === "home-decor"
          );
          ...
          if (userData.success && userData.data) {
            ...
            homeDecorProducts = homeDecorProducts.map(
              (product: IProductResponse) => ({
                ...product,
          ...
          >();
          homeDecorProducts.forEach((product: IProductResponse) => {
          ...
          // Price Range
          const prices = homeDecorProducts.map(
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <BreadcrumbHeader title="Home" subtitle="Home Decor" titleHref="/" />
            ...
            sortedProducts.map((product) => (
              ...
              >
                ...
                <div className="mb-4 h-48 w-full overflow-hidden rounded-lg">
                  <Link href={`/home-decor/${product._id}`}>
                    <Image
