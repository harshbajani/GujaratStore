...
const PrimaryCategoryPage = () => {
  ...
  const fetchPrimaryCategories = useCallback(async () => {
    ...
    try {
      ...
      const result = await getPrimaryCategoriesPaginated(params);

      if (!result.success) {
        throw new Error(result.error || "Failed to fetch primary categories");
      }
                ...
                {data.length > 0 ? (
                  data.map((primaryCategory) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <div>
                          {(primaryCategory.parentCategory as { name: string })
                            ?.name || "N/A"}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="truncate max-w-[200px]">
                          {primaryCategory.description || "N/A"}
                        </div>
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant={
                            primaryCategory.isActive ? "default" : "secondary"
                          }
                          className={
                        ...
                        >
                          {primaryCategory.isActive ? "Active" : "Inactive"}
                        </Badge>
                      </TableCell>
                      <TableCell>
                  ...
                  <TableRow>
                    ...
                    >
                      {loading ? "Loading..." : "No primary categories found"}
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
...
export default PrimaryCategoryPage;
