...
const CustomersPage = () => {
  ...
  const fetchCustomers = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/admin/user/customers?${queryParams}`, {
        method: "GET",
        headers: {
  ...
  const fetchCustomerStats = useCallback(async () => {
    try {
      ...
      const response = await fetch("/api/admin/user/customers/stats", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchNewCustomersForMonth = useCallback(async () => {
    try {
      const response = await fetch(
        `/api/admin/user/customers/new-monthly?month=${selectedMonth}&year=${selectedYear}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
