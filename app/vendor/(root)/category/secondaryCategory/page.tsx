        ...
        return (
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() =>
                router.push(
                  `/vendor/category/secondaryCategory/edit/${secondaryCategory.id}`
                )
              }
            >
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <Input
              ...
              className="max-w-sm"
            />
            <Link href="/vendor/category/secondaryCategory/add">
...
export default withVendorProtection(SecondaryCategoryPage);
